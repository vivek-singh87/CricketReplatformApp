      ...
      CharFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            /*** lines: 32-35 */
            __fileData.writeChars (959, 160, (CharFileDataSink)out);
          }
          finally {
      ...
      CharFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            DropletImports _imports = (DropletImports) request.getObjectParameter(ServletUtil.IMPORTS_NAME);
            /*** lines: 36-39 */
            __fileData.writeChars (1158, 159, (CharFileDataSink)out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      CharFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            DropletImports _imports = (DropletImports) request.getObjectParameter(ServletUtil.IMPORTS_NAME);
            /*** lines: 64-64 */
            __fileData.writeChars (2189, 35, (CharFileDataSink)out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      CharFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            DropletImports _imports = (DropletImports) request.getObjectParameter(ServletUtil.IMPORTS_NAME);
            /*** lines: 65-65 */
            __fileData.writeChars (2266, 25, (CharFileDataSink)out);
            out.print(ServletUtil.toString(((((Integer)request.getObjectParameter("count")).intValue() % 2) == 1) ? "even" : "odd"));
            /*** lines: 65-67 */
            __fileData.writeChars (2380, 13, (CharFileDataSink)out);
      ...
      CharFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            DropletImports _imports = (DropletImports) request.getObjectParameter(ServletUtil.IMPORTS_NAME);
            /*** lines: 52-56 */
            __fileData.writeChars (1682, 92, (CharFileDataSink)out);
            try {
              request.pushFrame();
            ...
            /*** lines: 70-72 */
            __fileData.writeChars (2612, 24, (CharFileDataSink)out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      throws ServletException, IOException
  {
    ...
    try {
      ...
      try {
        ...
        request.setParameterDelimiter(ServletUtil.getParamDelimiter(request));
        /*** lines: 13-13 */
        __fileData.writeChars (328, 64, (CharFileDataSink)out);
        ...
        /*** lines: 13-13 */
        __fileData.writeChars (393, 256, (CharFileDataSink)out);
        out.print(request.encodeURL ("cmpn-search.jhtml", true, true, false, true));
        /*** lines: 13-13 */
        __fileData.writeChars (666, 83, (CharFileDataSink)out);
        {
        ...
        /*** lines: 13-30 */
        __fileData.writeChars (760, 100, (CharFileDataSink)out);
        try {
          request.pushFrame();
        ...
        /*** lines: 40-47 */
        __fileData.writeChars (1341, 191, (CharFileDataSink)out);
        ...
        _form = null;
        /*** lines: 47-49 */
        __fileData.writeChars (1532, 13, (CharFileDataSink)out);
        try {
          request.pushFrame();
