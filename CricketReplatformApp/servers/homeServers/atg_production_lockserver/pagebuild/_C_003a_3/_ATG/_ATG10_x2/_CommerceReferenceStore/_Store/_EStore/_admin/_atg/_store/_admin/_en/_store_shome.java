package _C_003a_3._ATG._ATG10_x2._CommerceReferenceStore._Store._EStore._admin._atg._store._admin._en;
      ...
      throws ServletException, IOException
  {
    ...
    try {
      ...
      try {
        ...
        /*** lines: 1-5 */
        __fileData.writeBytes (46, 76, out);
/* @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/admin/atg/store/admin/en/store-home.jhtml#1 $$Change: 735822 $*/        /*** lines: 5-6 */
        __fileData.writeBytes (269, 2, out);
      } catch (Exception e) {
