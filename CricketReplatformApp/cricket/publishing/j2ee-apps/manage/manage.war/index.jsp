...
<dsp:importbean bean="/cricket/integration/zipcode/ManualConsumeZipCodeFeed"/>

<dsp:form action="/manage/index.jsp">
	consume feed <dsp:input type="submit" bean="ManualConsumeZipCodeFeed.manualConsume"/>
</dsp:form>

<head><title>manage JSP Index Page</title></head>
<body>
<h1>manage Test JSP Page</h1>
