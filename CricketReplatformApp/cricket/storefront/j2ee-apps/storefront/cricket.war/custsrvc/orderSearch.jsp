					      ...
					      <div class="row">
					        <div class="columns large-12 small-12">	
					          ...
					          <dsp:form style="display:none" action="${pageContext.request.requestURL}" name="getOrderSummaryForm" id="getOrderSummaryForm"  method="post">
		                			<dsp:input id="changeLoctionRedirectURL" type="hidden" value="" bean="CustSrvcOrderDetailsFormHandler.redirectURL"/>	
									<dsp:input id="setbillingOrderID" type="hidden" value="" bean="CustSrvcOrderDetailsFormHandler.billingOrderID"/>					
									<dsp:input id="setCustPassword" type="hidden" value="" bean="CustSrvcOrderDetailsFormHandler.custPassword"/>					
									<dsp:input id="successUrl" type="hidden" value="orderstatus.jsp" bean="CustSrvcOrderDetailsFormHandler.successURL"/>
									<dsp:input id="errorUrl" type="hidden" value="${pageContext.request.requestURL}" bean="CustSrvcOrderDetailsFormHandler.errorURL"/>
									<dsp:input id="retrieveOrderSubmit" type="submit" bean="CustSrvcOrderDetailsFormHandler.retrieveOrder" value="submit2"/>
							  </dsp:form>
								
					          <p>Enter the order confirmation number (Billing System ID).</p>
					      ...
					      <div class="row">
							<dsp:form iclass="form-container" name="getOrderIDForm" id="getOrderIDForm" action="#">
					            <div class="columns large-5 small-9">
					            	<dsp:input id="order_numI" name="order_numI" type="text" bean="CustSrvcOrderDetailsFormHandler.billingOrderID"/>
					            	<div class="columns large-12 small-12">
					          			<p>Password</p>
					        		</div>
					            	<dsp:input id="custPass" name="custPass" type="password" bean="CustSrvcOrderDetailsFormHandler.custPassword"/>
					            </div>
					        ...
					        <div class="columns large-12 small-12 errors-location">
					          <div id="erroremptyorder"><!--<p>No order exists for this order ID.</p>--></div>
						          <dsp:droplet name="Switch">
									<dsp:param name="value" bean="CustSrvcOrderDetailsFormHandler.responseVO.ifOrderExist"/>
