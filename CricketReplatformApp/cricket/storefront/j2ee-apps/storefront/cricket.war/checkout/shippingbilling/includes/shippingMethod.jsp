...
<div id="shipping-method-po-box1" >
		...
		<!-- </legend> -->
		<label for="method2" class="shipping-method-label method"> <input
			id="method2" type="radio" name="shipping-method-type2"
			checked="checked"> <crs:outMessage
				key="cricket_checkout_poboxfree" /> <!-- PO Box (5-7 Day Delivery) - FREE  -->
		</label>
