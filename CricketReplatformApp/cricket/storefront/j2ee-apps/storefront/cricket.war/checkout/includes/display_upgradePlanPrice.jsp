					...
					<c:if test="${!empty changePlanList }" >
						<c:forEach var="changePlan" items="${changePlanList}">
							<tr>
								...
								<td class="text-center"><!-- $${planProratedPrice} --><crs:outMessage key="cricket_shoppingcart_TBD"/><!-- TBD --></td>	
							</tr>
								...
								<dsp:droplet name="ProductLookup">
									...
									<dsp:oparam name="output">
										...
										<tr>
											...
											<td class="text-center"><!-- $${addonProratedPrice} --><crs:outMessage key="cricket_shoppingcart_TBD"/><!-- TBD --></td>
										</tr>
									</dsp:oparam>
								</dsp:droplet>
							</dsp:oparam>
 ...
 <tr class="icon-divider"><th></th></tr>
             ...
             <tr class="icon-divider"><th></th></tr>
				<tr class="package-total total">
                    ...
                    <td class="text-center"><!-- $${upgradePlanTotal} --><crs:outMessage key="cricket_shoppingcart_TBD"/><!-- TBD --></td>
                </tr>
		 <!--/.summary-container-->
</dsp:page>